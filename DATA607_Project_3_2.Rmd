...
Ultimately, we decided to utilize [Ballotpedia’s Super Tuesday primaries](https://ballotpedia.org/Super_Tuesday_primaries,_2024) and https://worldpopulationreview.com/state-rankings/registered-voters-by-state datasets. The websites have provided unbiased raw data from different states on topics of our interest, including voter turnout, registrations, voter enthusiasm, voter distribution, and total votes for different candidates.

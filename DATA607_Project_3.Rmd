...
registered voters and party affiliations. This comes from the
website https://worldpopulationreview.com/state-rankings/registered-voters-by-state.
...
To better visualize the data I will provide a table that display state
by their Average Total
...
There are two plot below, one show Republican votes by State and the
